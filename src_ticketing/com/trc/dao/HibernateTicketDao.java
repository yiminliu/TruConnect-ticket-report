...
public class HibernateTicketDao extends HibernateDaoSupport implements TicketDao{
  ...
  public List<Ticket> getAllTickets(){
	  return (List<Ticket>)getHibernateTemplate().find("from Ticket t order by t.id desc");
  }
  ...
  public List<Ticket> searchTicketByKeyword(String keyword) {
	  ...
	  List<Ticket> creatorList  = ht.find("from Ticket t where t.creator.username like ? order by t.id desc", wildCardKeyword(keyword));//searchTicket By Creator;
